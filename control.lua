...
SeamlessWorld = require("scripts/seamless_world")
...
gauge_connect_combinators = prometheus.gauge(
    ...
    "Connect combinators",
    { "combinator_key", "signal_type", "signal_name" }
)

gauge_transfer_leaks = prometheus.gauge(
    "factorio_transfer_leaks",
    "Transfer leaks",
    { "posX", "posY", "key" }
)
...
script.on_init(function()
	...
	ConnectCombinator.on_init()
	SeamlessWorld.on_init()
	...
	script.on_event(defines.events.on_built_entity, function(event)
	    ...
	    ConnectCombinator.on_added(event)
	    SeamlessWorld.on_added_entity(event.created_entity)
	end)
	...
	script.on_event(defines.events.on_player_mined_entity, function(event)
        ...
        ConnectCombinator.on_entity_destroyed(event)
        SeamlessWorld.on_destroyed_entity(event.entity.unit_number)
	end)
	...
	script.on_event(defines.events.on_entity_destroyed, function(event)
	    ConnectCombinator.on_destroyed(event)
	    SeamlessWorld.on_destroyed_entity(event.unit_number)
	end)
